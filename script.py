...
cpu_nice = psutil.cpu_times().nice # tarfa de nível baixo
cpu_iowait = psutil.cpu_times().iowait # tempo de aguardo de uma operação de entrada e saída
cpu_irq = psutil.cpu_times().irq # interrupt quest, quando um hardware chama a cpu
cpu_softirq = psutil.cpu_times().softirq # interrupção de software, precido com o de cima, mas nivel software
...
Idle: {cpu_idle:.2f} segundos
Nice: {cpu_nice:.2f} segundos
I/O Wait: {cpu_iowait:.2f} segundos
IRQ: {cpu_irq:.2f} segundos
SoftIRQ: {cpu_softirq:.2f} segundos
